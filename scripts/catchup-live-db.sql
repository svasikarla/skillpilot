-- CATCH-UP for the live Supabase DB, generated 2026-07-07.
-- The live schema is missing migrations 010, 013, 018, 019.
-- Paste this whole file into the Supabase SQL editor and run once.

-- ── from 010_platform_intelligence.sql ──
...
DROP POLICY IF EXISTS mpi_own ON member_platform_interests;
CREATE POLICY mpi_own ON member_platform_interests
  FOR ALL USING (user_id = auth.uid());

-- ── from 013_platform_guides.sql ──
...
-- ── from 018_fix_ingestion_runs.sql ──
...
-- ── from 019_profiles_digest_opt_out.sql ──
